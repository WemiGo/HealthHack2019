...
class MorePicsVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    //Outlets
    @IBOutlet weak var gumsBtn: UIButton!
    @IBOutlet weak var lipsBtn: UIButton!
    ...
    @objc func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        if let selImage = selectedImage{
            if lipsSelected{
                lipsBtn.imageView?.image = selImage
                imageLips = selImage
                IMAGE_LIPS = selImage
            } else if gumsSelected{
                gumsBtn.imageView?.image = selImage
                imageGums = selImage
                IMAGE_GUMS = selImage
            }
        }
